      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 py-8 sm:py-10">
        ...
        <div className="border-t border-white/10 mt-8 pt-6 text-xs text-white/55 space-y-2">
          ...
          <InlineSetting
            ...
            fallback="Изображения товаров могут отличаться от фактического вида. Все цены указаны в рублях. Условия оплаты, доставки и возврата описаны в соответствующих разделах сайта."
            as="p"
