      ...
      <main className="flex-1 bg-bg-light">
        <div className="max-w-4xl mx-auto px-3 sm:px-4 py-6 sm:py-8">
          ...
          <div className="bg-bg-white rounded-xl border border-border p-4 sm:p-6 md:p-8 mb-6 sm:mb-8">
            ...
            {aboutPage ? (
              <InlinePageContent id={aboutPage.id} content={aboutPage.content || "ТОПХИТ — современная торговая компания..."} />
            ) : (
              <div className="text-text-gray leading-relaxed space-y-4">
                <p className="text-lg text-text-dark">
                  ТОПХИТ — современная торговая компания, которая быстро развивается и формирует универсальную площадку для покупок.
                </p>
              </div>
            )}
          </div>
