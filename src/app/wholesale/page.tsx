    ...
    <>
      ...
      <main className="flex-1 bg-bg-light">
        <div className="max-w-4xl mx-auto px-4 py-8">
          <h1 className="text-2xl md:text-3xl font-bold text-text-dark mb-6">Оптовые продажи</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div className="bg-bg-white rounded-xl border border-border p-6">
              ...
              <ul className="space-y-2 text-sm text-text-gray">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-success mt-0.5">•</span>
                  Полный пакет документов (счёт-фактура, накладная, УПД)
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-success mt-0.5">•</span>
            ...
            <div className="bg-bg-white rounded-xl border border-border p-6">
              ...
              <ul className="space-y-2 text-sm text-text-gray">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-success mt-0.5">•</span>
                  Оплата наличными или по расчётному счёту
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-success mt-0.5">•</span>
                ...
                <li className="flex items-start gap-2">
                  <span className="text-success mt-0.5">•</span>
                  Минимальная сумма заказа от 10 000 ₽
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-success mt-0.5">•</span>
          ...
          <div className="bg-primary/5 border border-primary/20 rounded-xl p-6 text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <a href="tel:+74951203644" className="flex items-center gap-2 text-primary font-bold text-lg hover:underline">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                +7 (495) 120-36-44
              </a>
              <a href="mailto:opt@tophit.ru" className="flex items-center gap-2 text-primary font-bold hover:underline">
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
